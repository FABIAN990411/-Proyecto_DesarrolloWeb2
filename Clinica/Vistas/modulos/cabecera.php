<header class="main-header">
  ...
  <a href="http://localhost/clinica/inicio" class="logo">
    ...
    <span class="logo-mini"><b>Curar</b></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>Curar I P S S A S</b></span>
  </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              if ($_SESSION["foto"] == "") {
                ...
                echo '<img src="http://localhost/clinica/Vistas/img/img" style="width: 30px" class "user-image" alt="user image">';
                # code...
              } else {
