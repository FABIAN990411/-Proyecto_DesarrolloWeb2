...
class InicioC
{
	...
	public function MostrarInicioC()
	{
		...
		echo '<div class="box-body center">
	          <div class="col-lg-4 card espacio">
	            
	            <h2 class="text-center"><strong>Bienvenidos</strong></h2>

	            <h3><strong>' . $resultado["intro"] . '</strong></h3>

	            <h3><strong>Horario</strong></h3>
	            <h4><strong>Desde: </strong> ' . $resultado["horaE"] . '</h4>
	            <h4><strong>Hasta_: </strong> ' . $resultado["horaS"] . '</h4>

	            <h3><strong>Dirección</strong></h3>
	            <h4>' . $resultado["direccion"] . '</h4>

	            <h3><strong>Contactos_</strong></h3>
	            <h4><strong>Teléfono:</strong> ' . $resultado["telefono"] . ' </h4>
	            <h4><strong>Correo:</strong> ' . $resultado["correo"] . '</h4>
